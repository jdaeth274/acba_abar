...
def make_dna_db(seq_loc):
    ...
    if os.path.isdir('tmp_dna_lib'):
        print("Currently a tmp_dna_lib in run_loc, please highlight this using --dna-dir")
        sys.exit()
    else:
...
def contig_bounds(seqs):
    ...
    if os.path.isdir('contig_bounds'):
        print("Currently a contig_bounds in run_loc, please highlight this using --contig-bounds")
        sys.exit()
    else:
